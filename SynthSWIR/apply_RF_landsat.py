"""Functions to apply random forest model."""
import argparse
import numpy as np
import pandas as pd
import gdal
...
def predict(file_name):
    ...
    predictions = model.predict(sample.to_numpy())
    ...
    rs = gdal.GetDriverByName('GTiff').Create(file_name + '_RFpredicted.tif',
                                              c, b, a, gdal.GDT_Byte)
